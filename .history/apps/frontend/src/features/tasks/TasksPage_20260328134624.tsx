...
import { createTask, getTasks, TaskItem, TaskPriority, TaskStatus, updateTaskStatus } from '../../app/api';
import { useActor } from '../../app/actor-context';
import { NotificationToast } from '../../components/NotificationToast';
import { Plus, Loader2, CalendarDays, AlertTriangle, CheckCircle2, PauseCircle, User2 } from 'lucide-react';
      ...
      <article className="card main-card">
        ...
        <div className="task-toolbar">
          <div className="pill-group">
            <button className={currentView === 'board' ? 'pill active' : 'pill'} onClick={() => changeView('board')}>
              {t('tasks.views.board')}
            </button>
            <button className={currentView === 'mine' ? 'pill active' : 'pill'} onClick={() => changeView('mine')}>
              {t('tasks.views.mine')}
            </button>
            <button className={currentView === 'created' ? 'pill active' : 'pill'} onClick={() => changeView('created')}>
              {t('tasks.views.created')}
            </button>
          </div>
