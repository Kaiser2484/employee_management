...
const HIRE_ROLE_OPTIONS: EmployeeRole[] = ['employee', 'team_lead', 'manager', 'hr', 'admin'];
...
export function RecruitmentPage() {
  ...
  async function handleHireCandidate(event: FormEvent) {
    ...
    if (hireForm.fullName.trim().length < 3 || !hireForm.email.trim() || hireForm.password.length < 8 || !hireForm.degree.trim()) {
      showToast(t('recruitment.validation.hireBasic'), 'error');
      return;
    }
    ...
    const payload: CreateEmployeePayload = {
      ...
      gender: hireForm.gender.trim() || undefined,
      dateOfBirth: hireForm.dateOfBirth || undefined,
      startDate: hireForm.startDate || undefined,
      nationalId: hireForm.nationalId.trim() || undefined,
      address: hireForm.address.trim() || undefined,
      employeeStatus: hireForm.employeeStatus.trim() || undefined,
      jobCategory: hireForm.jobCategory.trim() || undefined,
      jobTitle: hireForm.jobTitle.trim() || undefined,
      photoUrl: hireForm.photoUrl || undefined,
    };
