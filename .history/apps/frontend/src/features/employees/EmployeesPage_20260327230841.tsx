              ...
              <div className="members-list">
                ...
                <div className="member-item">
                  ...
                  <span className="member-role">
                    {extraDegreesByEmployee[selectedEducation.id]?.length
                      ? t('employees.education.extraDegreesCount', {
                          count: extraDegreesByEmployee[selectedEducation.id].length,
                        })
                ...
                {extraDegreesByEmployee[selectedEducation.id]?.length ? (
                  <div className="file-list-preview">
                    {extraDegreesByEmployee[selectedEducation.id].map((file, index) => (
                ...
                <div className="member-item full-width">
                  <label className="employees-filter-item" htmlFor={`upload-extra-degrees-${selectedEducation.id}`}>
                    <span>{t('employees.education.uploadExtraDegrees')}</span>
                    <input
                      id={`upload-extra-degrees-${selectedEducation.id}`}
                      className="input-control"
                      type="file"
                      multiple
                      accept=".pdf,.jpg,.jpeg,.png"
                      onChange={(event) => handleUploadExtraDegrees(selectedEducation.id, event.target.files)}
                    />
                  </label>
                </div>
              </div>
