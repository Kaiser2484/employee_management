...
export type AppRoute = '/tasks' | '/employees' | '/leave' | '/schedule' | '/recruitment' | '/administration';
...
const scheduleRoles: ActorRole[] = ['admin', 'hr', 'manager', 'team_lead', 'employee'];
...
export function canAccessSchedule(role: ActorRole): boolean {
